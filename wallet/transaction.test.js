...
const { verifySignature, ec } = require('../util');
...
describe('Transaction', () => {
    ...
    describe('input', () => {
        ...
        it('has an `amount` set to the `senderWallet` balance', () => {
            expect(transaction.input.amount).toEqual(senderWallet.balance)
        });

        it('has an `adress` set to the `senderWallet` publicKey', () => {
            expect(transaction.input.address).toEqual(senderWallet.publicKey);
        });

        it('has a `signature` that signs the input', () => {
            expect(
                verifySignature({
