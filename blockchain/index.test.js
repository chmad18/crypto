...
describe('Blockchain', () => {
    ...
    it('it starts with a genesis block', () => {
        expect(blockchain.chain[0]).toEqual(Block.genesis());
    });

    it('adds a new block to new chain', () => {
        const data = 'data';
    ...
    describe('isValidChain()', () => {
        ...
        describe('when the chain starts with the genesis block and have multiple blocks', () => {
            ...
            describe('and a lastHash has reference changed', () => {
                it('returns false', () => {
            ...
            describe('and the chain contains an invalid field', () => {
                it('returns false', () => {
                    blockchain.chain[2].data = 'broken-field';
                    expect(Blockchain.isValidChain(blockchain.chain)).toBe(false);
                });
            });
    ...
    describe('validTransactionData()', () => {
        ...
        describe('and the block contains mulitple identical transactions', () => {
            it('returns false and logs an error', () => {
                newChain.addBlock({
